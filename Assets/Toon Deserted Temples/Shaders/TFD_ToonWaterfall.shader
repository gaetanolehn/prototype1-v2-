	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord9.zw = vertexToFrag366;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord648 = input.ase_texcoord9.xy * float2( 4,1 ) + float2( 0,0 );
				float2 panner644 = ( 1.1 * _Time.y * ( FlowSpeed794 * float2( 0,1.31 ) ) + texCoord648);
				float2 texCoord700 = input.ase_texcoord9.xy * float2( 3,1 ) + float2( 0,0 );
				...
				float2 texCoord820 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 vertexToFrag366 = input.ase_texcoord9.zw;
				...
				float2 texCoord376 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 ase_positionWS = TransformObjectToWorld( (input.positionOS).xyz );
				float2 vertexToFrag366 = ( (ase_positionWS).xz * float2( 0.025,0.025 ) );
				output.ase_texcoord5.zw = vertexToFrag366;
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float NormalCalc863 = dotResult860;
				float2 FlowSpeed794 = _FlowSpeed;
				float2 texCoord648 = input.ase_texcoord5.xy * float2( 4,1 ) + float2( 0,0 );
				float2 panner644 = ( 1.1 * _Time.y * ( FlowSpeed794 * float2( 0,1.31 ) ) + texCoord648);
				float2 texCoord700 = input.ase_texcoord5.xy * float2( 3,1 ) + float2( 0,0 );
				float2 panner701 = ( 1.1 * _Time.y * ( FlowSpeed794 * float2( 0,-0.32 ) ) + texCoord700);
				float2 texCoord677 = input.ase_texcoord5.xy * float2( 2,1 ) + float2( 0,0 );
				float2 panner678 = ( 1.1 * _Time.y * ( FlowSpeed794 * float2( 0,2 ) ) + texCoord677);
				float2 texCoord820 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner819 = ( 1.1 * _Time.y * ( FlowSpeed794 * float2( 0,2.6 ) ) + texCoord820);
				float4 blendOpSrc825 = tex2D( _NoiseTexture3, panner678 );
				float4 blendOpDest825 = ( NormalCalc863 * tex2D( _NoiseTexture3, panner819 ) );
				float4 lerpBlendMode825 = lerp(blendOpDest825,( blendOpSrc825 + blendOpDest825 ),NormalCalc863);
				...
				float2 appendResult31 = (float2(( ase_positionSSNorm.x + 0.01 ) , ( ase_positionSSNorm.y + 0.01 )));
				float2 temp_cast_1 = (_ReflectionsScrollSpeed).xx;
				float2 vertexToFrag366 = input.ase_texcoord5.zw;
				float2 GlobalUV368 = vertexToFrag366;
				float2 panner40 = ( 1.0 * _Time.y * temp_cast_1 + ( _ReflectionsScale * GlobalUV368 ));
				float Turbulence291 = ( UnpackNormalScale( tex2D( _NormalMap, panner40 ), 1.0f ).g * (0.0 + (_ReflectionsOpacity - 0.0) * (8.0 - 0.0) / (1.0 - 0.0)) * input.ase_color.r );
				float4 lerpResult24 = lerp( ase_positionSSNorm , float4( appendResult31, 0.0 , 0.0 ) , Turbulence291);
				...
				float2 texCoord376 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float ase_lightAtten = 0;
				Light ase_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
				float3 lerpResult90 = lerp( ( ReflexionsCutoff612 * float3( texCoord376 ,  0.0 ) ) , ( ase_lightColor.rgb * ( ReflexionsCutoff612 * ase_lightAtten ) ) , ( 1.0 - ase_lightAtten ));
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 ase_positionWS = TransformObjectToWorld( (input.positionOS).xyz );
				float2 vertexToFrag366 = ( (ase_positionWS).xz * float2( 0.025,0.025 ) );
				output.ase_texcoord3.zw = vertexToFrag366;
				float3 ase_tangentWS = TransformObjectToWorldDir(input.ase_tangent.xyz);
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float NormalCalc863 = dotResult860;
				float2 FlowSpeed794 = _FlowSpeed;
				float2 texCoord648 = input.ase_texcoord3.xy * float2( 4,1 ) + float2( 0,0 );
				float2 panner644 = ( 1.1 * _Time.y * ( FlowSpeed794 * float2( 0,1.31 ) ) + texCoord648);
				float2 texCoord700 = input.ase_texcoord3.xy * float2( 3,1 ) + float2( 0,0 );
				float2 panner701 = ( 1.1 * _Time.y * ( FlowSpeed794 * float2( 0,-0.32 ) ) + texCoord700);
				float2 texCoord677 = input.ase_texcoord3.xy * float2( 2,1 ) + float2( 0,0 );
				float2 panner678 = ( 1.1 * _Time.y * ( FlowSpeed794 * float2( 0,2 ) ) + texCoord677);
				float2 texCoord820 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner819 = ( 1.1 * _Time.y * ( FlowSpeed794 * float2( 0,2.6 ) ) + texCoord820);
				float4 blendOpSrc825 = tex2D( _NoiseTexture3, panner678 );
				float4 blendOpDest825 = ( NormalCalc863 * tex2D( _NoiseTexture3, panner819 ) );
				float4 lerpBlendMode825 = lerp(blendOpDest825,( blendOpSrc825 + blendOpDest825 ),NormalCalc863);
				...
				float2 appendResult31 = (float2(( ase_positionSSNorm.x + 0.01 ) , ( ase_positionSSNorm.y + 0.01 )));
				float2 temp_cast_1 = (_ReflectionsScrollSpeed).xx;
				float2 vertexToFrag366 = input.ase_texcoord3.zw;
				float2 GlobalUV368 = vertexToFrag366;
				float2 panner40 = ( 1.0 * _Time.y * temp_cast_1 + ( _ReflectionsScale * GlobalUV368 ));
				float Turbulence291 = ( UnpackNormalScale( tex2D( _NormalMap, panner40 ), 1.0f ).g * (0.0 + (_ReflectionsOpacity - 0.0) * (8.0 - 0.0) / (1.0 - 0.0)) * input.ase_color.r );
				float4 lerpResult24 = lerp( ase_positionSSNorm , float4( appendResult31, 0.0 , 0.0 ) , Turbulence291);
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;908;720,-1536;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Toon/TFD_ToonWaterfall;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;45;Lighting Model;0;0;Workflow;1;0;Surface;1;638615032715288306;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Alpha Clipping;1;0;  Use Shadow Threshold;0;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;1;638615696143923367;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;0;638615205409764263;Receive Shadows;1;0;Receive SSAO;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;11;False;True;False;True;True;True;True;False;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;918;720,-1436;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=B50726C55D11A2F72E41D83659EA06174CDD4B55