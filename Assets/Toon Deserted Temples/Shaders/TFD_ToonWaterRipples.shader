	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord637 = input.ase_texcoord4.xy * float2( 2,2 ) + float2( 0,0 );
				float2 panner639 = ( 1.0 * _Time.y * ( _ScrollingSpeed * float2( 0,0.8 ) ) + texCoord637);
				float2 texCoord646 = input.ase_texcoord4.xy * float2( 3,2 ) + float2( 0,0 );
				...
				float Alpha = ( temp_output_643_0 * input.ase_color.a ).r;
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord637 = input.ase_texcoord3.xy * float2( 2,2 ) + float2( 0,0 );
				float2 panner639 = ( 1.0 * _Time.y * ( _ScrollingSpeed * float2( 0,0.8 ) ) + texCoord637);
				float2 texCoord646 = input.ase_texcoord3.xy * float2( 3,2 ) + float2( 0,0 );
				float2 panner647 = ( 1.0 * _Time.y * _ScrollingSpeed + texCoord646);
				float4 temp_output_643_0 = ( tex2D( _NoiseMap, panner639 ) + tex2D( _NoiseMap, panner647 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float2 texCoord637 = input.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
				float2 panner639 = ( 1.0 * _Time.y * ( _ScrollingSpeed * float2( 0,0.8 ) ) + texCoord637);
				float2 texCoord646 = input.ase_texcoord.xy * float2( 3,2 ) + float2( 0,0 );
				float2 panner647 = ( 1.0 * _Time.y * _ScrollingSpeed + texCoord646);
				float4 temp_output_643_0 = ( tex2D( _NoiseMap, panner639 ) + tex2D( _NoiseMap, panner647 ) );
				

				surfaceDescription.Alpha = ( temp_output_643_0 * input.ase_color.a ).r;
		...
		Pass
		{
			...
			half4 frag(	PackedVaryings input  ) : SV_Target
			{
				...
				float2 texCoord637 = input.ase_texcoord2.xy * float2( 2,2 ) + float2( 0,0 );
				float2 panner639 = ( 1.0 * _Time.y * ( _ScrollingSpeed * float2( 0,0.8 ) ) + texCoord637);
				float2 texCoord646 = input.ase_texcoord2.xy * float2( 3,2 ) + float2( 0,0 );
				float2 panner647 = ( 1.0 * _Time.y * _ScrollingSpeed + texCoord646);
				float4 temp_output_643_0 = ( tex2D( _NoiseMap, panner639 ) + tex2D( _NoiseMap, panner647 ) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;673;1216,-1196;Float;False;False;-1;3;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=8FCE9459773AC3749F125348A08DF49BA3D332A1